...
function isCheckTextMessage(n) {
  return "CHECK_TEXT" === n.command
}
...
function isLoadPhrasesMessage(n) {
  return "LOAD_PHRASES" === n.command
}

function isReportRephraseMessage(n) {
  return "REPORT_PHRASE" === n.command
}
...
function isCheckTextResult(n) {
  return "CHECK_TEXT" === n.initialCommand && n.isSuccessful
}
